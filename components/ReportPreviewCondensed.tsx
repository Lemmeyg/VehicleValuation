    ...
    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
      <div className="p-4 sm:p-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl sm:text-5xl font-bold text-slate-900 mb-2">2021 BMW X3</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-10">
          {/* Low Range */}
          <div className="bg-white border-l-4 border-slate-400 rounded-lg p-4 sm:p-5 shadow-sm flex sm:block items-center justify-between">
            <div>
              <div className="text-xs font-semibold text-slate-600 tracking-wide uppercase">
                LOW RANGE
              </div>
              <div className="text-xs text-slate-500 mt-1 sm:mb-2">Market floor estimate</div>
            </div>
            <div className="text-xl sm:text-3xl font-bold text-slate-900">$20,389</div>
          </div>

          {/* Market Value - Primary */}
          <div className="bg-white border-l-4 border-emerald-500 rounded-lg p-4 sm:p-5 shadow-sm flex sm:block items-center justify-between">
            <div>
              <div className="text-xs font-semibold text-emerald-600 tracking-wide uppercase">
                MARKET VALUE
              </div>
              <div className="text-xs text-emerald-600 font-semibold mt-1 sm:mb-1">
                MEDIUM CONFIDENCE
              </div>
            </div>
            <div className="text-xl sm:text-3xl font-bold text-slate-900">$22,654</div>
          </div>

          {/* High Range */}
          <div className="bg-white border-l-4 border-blue-500 rounded-lg p-4 sm:p-5 shadow-sm flex sm:block items-center justify-between">
            <div>
              <div className="text-xs font-semibold text-blue-600 tracking-wide uppercase">
                HIGH RANGE
              </div>
              <div className="text-xs text-slate-500 mt-1 sm:mb-2">Market ceiling estimate</div>
            </div>
            <div className="text-xl sm:text-3xl font-bold text-slate-900">$24,919</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4">
            <div className="text-center p-2 sm:p-3 bg-slate-50 rounded-lg">
              ...
              <div className="text-base sm:text-lg font-bold text-slate-900">$20,389</div>
            </div>
            <div className="text-center p-2 sm:p-3 bg-emerald-50 rounded-lg border-2 border-emerald-200">
              <div className="text-xs font-semibold text-emerald-600 uppercase mb-1">
                Fair Market Value
              </div>
              <div className="text-base sm:text-lg font-bold text-emerald-700">$22,654</div>
            </div>
            <div className="text-center p-2 sm:p-3 bg-slate-50 rounded-lg">
              <div className="text-xs font-semibold text-slate-500 uppercase mb-1">High Range</div>
              <div className="text-base sm:text-lg font-bold text-slate-900">$24,919</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6">
          ...
          {/* Mobile card list — hidden on sm+ where table is shown */}
          <div className="block sm:hidden space-y-2" data-testid="comparables-mobile">
            {COMPARABLES.map((comp, idx) => (
              <div
                key={idx}
                className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-100"
              >
                <div className="w-10 h-8 rounded bg-slate-200 flex items-center justify-center flex-shrink-0">
                  <Car className="h-4 w-4 text-slate-400" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-semibold text-slate-900">2021 BMW X3 30i</div>
                  <div className="text-xs text-slate-500">{comp.mileage} mi</div>
                </div>
                <div className="text-sm font-bold text-emerald-600 whitespace-nowrap">
                  {comp.price}
                </div>
