...
export const metadata: Metadata = {
  title: 'Terms and Conditions | TotalLossToolKit.com',
  description: 'Terms and conditions for using TotalLossToolKit.com vehicle valuation services.',
  alternates: {
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  By accessing or using this website (the &quot;Service&quot;), you agree to these
                  Terms and Conditions (&quot;Terms&quot;). These form a binding contract between
                  you (&quot;User,&quot; &quot;you,&quot; or &quot;your&quot;) and LolaDev LLC,
                  Owner of TotalLossToolKit.com (&quot;we,&quot; &quot;us,&quot; or
                  &quot;our&quot;). If you do not agree, do not use the Service. We may update Terms
                  anytime; continued use means acceptance.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  The Service offers vehicle valuation estimates via third party API services
                  (retail predictions from dealer listings), links/references to vehicle owners, a
                  directory of service providers in relevant areas and a knowledge base with
                  informational articles. None constitute endorsements, partnerships, or
                  legal/financial advice. Service advisors/providers are independent and
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Use a strong password meeting our minimum security requirements (at least 8
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  ...
                  including any unauthorized use. You agree to:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                  ...
                  <li>
                    Immediately notify us if you become aware of any security breach related to the
                    Service
                  </li>
                  <li>Take all reasonable steps to prevent unauthorized access to your account</li>
                  <li>
                    Accept full liability for all activities conducted through your account, even if
                    conducted by an unauthorized third party, unless you have notified us of the
                    breach
                  </li>
                </ul>
                <p className="text-slate-600 leading-relaxed mb-4">
                  <strong>Important:</strong> Failure to maintain account security may result in
                  immediate termination of your account and potential liability for any damages
                ...
                <p className="text-slate-600 leading-relaxed">
                  Any attempted transfer or sharing may result in immediate account termination
                  without refund.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    Use automated systems, bots, scrapers, or any automated means to access the
                    Service, reports, or directories (accessing the knowledge base for personal
                    reading is permitted)
                  </li>
                  <li>
                    Attempt to reverse engineer, decompile, or extract source code from any part of
                    the Service
                  </li>
                  <li>
                    Use the Service for commercial resale or to operate as an intermediary for other
                    parties without our express written permission
                  </li>
                  <li>
                    Circumvent, disable, or interfere with security features or features that
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Share, distribute, or resell vehicle valuation reports to unauthorized third
                    parties for commercial purposes
                  </li>
                  <li>
                    Use data obtained from the Service to harass, defraud, or misrepresent
                    information to insurance companies or other parties
                  </li>
                  <li>Misrepresent the source, accuracy, or completeness of valuation data</li>
                  <li>
                    Remove, obscure, or alter any proprietary notices or attributions in reports or
                    materials
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Interfere with or disrupt the Service or servers/networks connected to the
                    Service
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  By submitting a Vehicle Identification Number (VIN) to our Service, you represent
                  and warrant that:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>You are the legal owner of the vehicle associated with the VIN, OR</li>
                  <li>
                    You have explicit authorization from the vehicle owner to submit the VIN and
                    obtain a valuation report
                  </li>
                  <li>
                    The VIN you submit is accurate and not fraudulent, stolen, or obtained through
                    illegal means
                  </li>
                  <li>
                    You will use the valuation report only for lawful purposes related to your
                    legitimate interest in the vehicle
                  </li>
                  <li>
                    You have disclosed to the vehicle owner (if you are not the owner) how their VIN
                    data will be used
                  </li>
                </ul>
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  While we strive to provide accurate vehicle valuations, you acknowledge and agree
                  that:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    You should independently verify all VIN data and valuation information before
                    making decisions
                  </li>
                  <li>
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  The Service uses multiple third-party APIs to provide vehicle data. You
                  acknowledge that:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    API providers may experience outages, errors, or data quality issues beyond our
                    control
                  </li>
                  <li>
                    We are not liable for any inaccuracies, downtime, or errors in data provided by
                    any third-party data source
                  </li>
                  <li>
                    API data reflects listings and market conditions at a point in time and may not
                    represent final sale values or insurance settlements
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Provide accurate info; use lawfully. Do not rely solely on valuations, articles,
                  or providers for decisions like total loss claims, repairs, or sales—verify
                  independently. Vehicle owners: Adjust estimates for condition/mileage; cross-check
                  with inspections. No sharing of advisor contacts implies our involvement.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Payment processing fees are non-refundable, even if you receive a refund for the
                    service
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Any pricing changes will apply to future purchases only; existing purchases are
                    not affected
                  </li>
                </ul>
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  Our refund policy and money-back guarantee are detailed in our{' '}
                  <a href="/guarantee" className="text-blue-600 hover:text-blue-800 underline">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    Refund requests must meet specific eligibility criteria outlined in our
                  ...
                  <li>
                    ...
                    documentation for full terms and conditions
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    We may suspend or terminate access to your account until payment issues are
                    resolved
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Insurance companies make independent decisions based on their own policies,
                    appraisals, and criteria
                  </li>
                  <li>
                    Our valuations are estimates based on market data and do not constitute binding
                    assessments
                  </li>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Actual vehicle condition, mileage, and market factors may differ from report
                    assumptions
                  </li>
                </ul>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  All content—including valuations, provider links, knowledge base articles, and
                  advisor info—is &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; without warranties
                  of accuracy, completeness, merchantability, fitness, or non-infringement.
                  Valuations reflect listings, not sales/settlements. Knowledge base is educational
                  only, not legal/tax advice. We disclaim liability for third-party services, data
                  errors, or advice outcomes.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Nothing on the Service is legal, financial, insurance, or professional advice.
                  Consult licensed attorneys, accountants, or advisors for your situation. Knowledge
                  base articles are general info; user misinterpretation does not create liability.
                  Service advisors are external; we have no control over, affiliation with, or
                  responsibility for their services, accuracy, or conduct.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Links to service providers are for convenience only—no endorsement, warranty, or
                  agency relationship exists. We are not liable for their acts, omissions, quality,
                  pricing, or disputes. Providers operate independently; any claims against them
                  must be directed solely to them. Users assume all risks of engaging third parties
                  via our site.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  Our total aggregate liability to you for all claims arising from or related to the
                  Service is limited to the lesser of:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>$100, OR</li>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Claims arising from inaccurate data, third-party services, knowledge base
                    content, or unaffiliated advisors
                  </li>
                ...
                <p className="text-slate-600 leading-relaxed">
                  You acknowledge that we have set our prices and entered into this agreement in
                  reliance upon these limitations of liability, and that these limitations reflect a
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  You and TotalLoss Tool Kit agree that any dispute, claim, or controversy arising
                  out of or relating to these Terms or the Service (collectively,
                  &quot;Disputes&quot;) will be resolved through{' '}
                  <strong>binding arbitration</strong> rather than in court, except as specified in
                  the &quot;Exceptions to Arbitration&quot; section below.
                </p>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    The arbitration will take place in New Jersey unless both parties agree
                    otherwise
                  </li>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  <strong>
                    YOU AND TOTAL LOSS TOOL KIT AGREE THAT DISPUTES WILL BE RESOLVED ONLY ON AN
                    INDIVIDUAL BASIS AND NOT AS A CLASS ACTION, CLASS ARBITRATION, OR ANY OTHER
                    CONSOLIDATED PROCEEDING.
                  </strong>
                </p>
                <p className="text-slate-600 leading-relaxed mb-4">
                  Neither you nor we may bring a claim on behalf of other individuals or entities,
                  nor participate as a class member in any class or consolidated proceeding. If this
                  class action waiver is found to be unenforceable, the entire arbitration agreement
                  will be void.
                </p>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Either party may bring such claims in small claims court or, if the matter is
                  outside small claims court jurisdiction, in state or federal courts located in New
                  Jersey.
                </p>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    For claims under $10,000, we will pay all arbitration filing fees and
                    administrative costs
                  </li>
                  <li>For claims over $10,000, fees will be allocated according to AAA rules</li>
                  <li>
                    Each party will bear its own attorney&apos;s fees unless the arbitrator awards
                ...
                <p className="text-slate-600 leading-relaxed">
                  Before initiating arbitration, you must send written notice to us describing the
                  dispute via our contact form. We will have 30 days to attempt to resolve the
                  dispute informally. If unresolved, either party may commence arbitration.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  We reserve the right to suspend, disable, or terminate your account and access to
                  the Service, with or without notice, for:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  For serious violations (as defined in &quot;Prohibited Uses and Activities&quot;),
                  we may:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    ...
                    continue to apply (including Indemnification, Limitation of Liability, Dispute
                ...
                <p className="text-slate-600 leading-relaxed">
                  We will not be liable to you or any third party for any termination of your
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  For any disputes not subject to arbitration (as specified in the &quot;Exceptions
                  to Arbitration&quot; section):
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    You agree that any legal action must be brought exclusively in the state or
                  ...
                  <table className="min-w-full border border-slate-300 text-sm">
                    ...
                    <tbody className="text-slate-600">
                      <tr>
                        ...
                        <td className="border border-slate-300 px-4 py-2">
                          Retail listings only, not final values
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
                          Verify with KBB/inspection
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-slate-300 px-4 py-2">
                      ...
                      <tr>
                        <td className="border border-slate-300 px-4 py-2">
                          <strong>Total Loss Use</strong>
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
                          Benchmark, not settlement guarantee
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
                          Submit comps/proof to insurer
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-slate-300 px-4 py-2">
                        ...
                        <td className="border border-slate-300 px-4 py-2">
                          Third-party API data; may contain errors
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
                          Independently verify all data
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-slate-300 px-4 py-2">
                        ...
                        <td className="border border-slate-300 px-4 py-2">
                          User fully responsible for all activity
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
                          Use strong password; report breaches immediately
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-slate-300 px-4 py-2">
                          <strong>Insurance Outcomes</strong>
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
                          No guarantee of settlement amounts
                        </td>
                        <td className="border border-slate-300 px-4 py-2">
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  ...
                  sole discretion. Changes may include:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    For material changes, we will provide notice through email or a prominent notice
                    on our website at least 15 days before the changes take effect
                  </li>
                  <li>
                ...
                <p className="text-slate-600 leading-relaxed">
                  It is your responsibility to review these Terms periodically for updates. If you
                  do not agree to modified Terms, you must stop using the Service and may request
                  account termination.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  These Terms, together with our Privacy Policy and Money-Back Guarantee policy,
                  constitute the entire agreement between you and TotalLoss Tool Kit regarding the
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Our failure to enforce any provision of these Terms will not constitute a waiver
                  of that provision or any other provision. No waiver will be effective unless made
                  in writing and signed by an authorized representative of TotalLoss Tool Kit.
                </p>

                <h3 className="text-xl font-semibold text-slate-900 mb-3">Assignment</h3>
                <p className="text-slate-600 leading-relaxed mb-4">
                  You may not assign or transfer these Terms or your account to any third party
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  ...
                  these Terms due to circumstances beyond our reasonable control, including acts of
                  God, natural disasters, war, terrorism, labor disputes, or internet service
                  provider failures.
                </p>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Nothing in these Terms creates any partnership, joint venture, agency, franchise,
                  sales representative, or employment relationship between you and TotalLoss Tool
                  Kit. You have no authority to bind us or make commitments on our behalf.
                </p>

                <h3 className="text-xl font-semibold text-slate-900 mb-3">Headings</h3>
                <p className="text-slate-600 leading-relaxed">
                  Section headings in these Terms are for convenience only and have no legal or
                  contractual effect.
                </p>
              </section>
              ...
              <div className="border-t border-slate-200 pt-6 mt-8">
                ...
                <p className="text-sm text-slate-600 italic">
                  These Terms and Conditions are legally binding. By using our Service, you
