...
export const metadata: Metadata = {
  title: 'Privacy Policy | TotalLossToolKit.com',
  description:
    'Learn how TotalLossToolKit.com collects, uses, and protects your personal information.',
  alternates: {
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <section className="mb-8 p-6 bg-slate-50 rounded-lg">
                ...
                <ol className="list-decimal pl-6 text-slate-600 space-y-1">
                  <li>
                    <a href="#introduction" className="text-primary-600 hover:underline">
                      Introduction
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#how-we-use" className="text-primary-600 hover:underline">
                      How We Use Your Information
                    </a>
                  </li>
                  <li>
                    <a href="#how-we-protect" className="text-primary-600 hover:underline">
                      How We Protect Your Information
                    </a>
                  </li>
                  <li>
                    <a href="#data-sharing" className="text-primary-600 hover:underline">
                      Data Sharing and Third Parties
                    </a>
                  </li>
                  <li>
                    <a href="#data-retention" className="text-primary-600 hover:underline">
                      Data Retention
                    </a>
                  </li>
                  <li>
                    <a href="#privacy-rights" className="text-primary-600 hover:underline">
                      Your Privacy Rights
                    </a>
                  </li>
                  <li>
                    <a href="#childrens-privacy" className="text-primary-600 hover:underline">
                      Children&apos;s Privacy
                    </a>
                  </li>
                  <li>
              ...
              <section id="introduction" className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Welcome to Total Loss Tool Kit. We are committed to protecting your privacy and
                  being transparent about how we collect, use, and protect your personal
                  information. This Privacy Policy explains our practices regarding data collection
                  and your rights as a user.
                </p>
                <p className="text-slate-600 leading-relaxed">
                  Our service helps vehicle owners obtain comprehensive valuation reports for
                  insurance negotiations. We take the sensitivity of vehicle-related data seriously
                  and have implemented measures to protect your information.
                </p>
              </section>
              ...
              <section id="information-we-collect" className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    <strong>Vehicle Identification Numbers (VINs)</strong> - We recognize that VINs
                    are sensitive data as they can be linked to personal vehicle ownership records
                    and may reveal information about your vehicle and insurance claims
                  </li>
                  <li>
                    <strong>Vehicle Mileage</strong> - This data is not considered sensitive or
                    private but is handled in the same manner as VIN data
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    <strong>IP addresses</strong> - Used for security, fraud prevention, and general
                    analytics
                  </li>
                  <li>
                    <strong>Usage data and analytics</strong> - We use standard software to collect
                    information about how you interact with our website, including pages visited,
                    features used, and time spent on our platform
                  </li>
                </ul>

                <h3 className="text-xl font-semibold text-slate-900 mb-3">Payment Information</h3>
                <p className="text-slate-600 leading-relaxed mb-3">
                  We do not directly collect or store payment information. All payment processing is
                  handled securely by:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    <strong>Lemon Squeezy</strong> - These third-party payment processors collect
                    and process payment card information according to their own privacy policies and
              ...
              <section id="how-we-use" className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    You will receive clear notice and obtain your consent before initiating any
              ...
              <section id="how-we-protect" className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  We take the security of your personal information seriously and implement multiple
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    All user data is stored on <strong>Supabase</strong>, a secure cloud database
                    platform
                  </li>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    We implement strict access controls limiting who can view or handle sensitive
                    data
                  </li>
                  <li>
                    Only authorized personnel have access to user information on a need-to-know
                    basis
                  </li>
                ...
                <p className="text-slate-600 leading-relaxed mb-3">
                  Because VINs are considered sensitive personal identifiers that can be linked to
                  vehicle ownership:
                </p>
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>We limit VIN data access to essential operations only</li>
                  <li>
                    VINs are only shared with trusted API providers necessary for generating your
                    reports
                  </li>
                  <li>
                ...
                <p className="text-slate-600 leading-relaxed">
                  <strong>Please note:</strong> While we implement robust security measures, no
                  method of electronic storage or internet transmission is 100% secure. We cannot
                  guarantee absolute security but continuously work to protect your information.
                </p>
              </section>
              ...
              <section id="data-sharing" className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  We share limited information with trusted third-party providers who help us
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  We use multiple third-party API providers to generate vehicle valuation reports.
                  These providers receive VIN data solely to generate vehicle valuation reports.
                  They operate under their own privacy policies and are contractually obligated to
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    We do <strong>not</strong> share your VIN data for marketing purposes
                  </li>
                  <li>
                    We do <strong>not</strong> provide your information to data brokers
                  </li>
                </ul>
              ...
              <section id="data-retention" className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  <li>
                    Account information and VIN submissions are retained while your account is
                    active
                  </li>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Some information may be retained for legal or business purposes (e.g.,
              ...
              <section id="privacy-rights" className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Account deletion can be initiated through your account settings or by contacting
                    us
                  </li>
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    Right to opt-out of the sale of personal information (note: we do not sell
                ...
                <p className="text-slate-600 leading-relaxed">
                  <strong>To Exercise Your Rights:</strong> Submit a request through our contact
                  form on the website. We will respond to your request within 30 days.
                </p>
              </section>
              ...
              <section id="childrens-privacy" className="mb-8">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Our service is designed for vehicle owners and insurance claimants. We do not
                  knowingly collect personal information from individuals under the age of 16. By
                  using our service, you confirm that you are at least 16 years of age.
                </p>
                <p className="text-slate-600 leading-relaxed">
                  If we discover that we have inadvertently collected information from someone under
                  16, we will promptly delete that information. If you believe we may have collected
                  information from a minor, please contact us immediately through our contact form.
                </p>
              </section>
              ...
              <section id="changes" className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 text-slate-600 space-y-2">
                  ...
                  <li>
                    For significant changes, we will notify you via email or through a prominent
                    notice on our website
                  </li>
                  <li>
                    Your continued use of our service after changes constitutes acceptance of the
                    updated policy
                  </li>
                </ul>
              ...
              <div className="border-t border-slate-200 pt-6 mt-8">
                ...
                <p className="text-sm text-slate-600 italic">
                  ...
                  CCPA (California Consumer Privacy Act) and general privacy best practices. Users
                  are advised to read this policy carefully and contact us with any questions.
                </p>
              </div>
            </div>
          </div>
