...
export default function PricingPage() {
  ...
  const handleTierSelect = async (tierId: string) => {
    ...
    if (!session || !session.user) {
      ...
      // User logged in - create report and redirect to view page
      await createReportAndRedirect(tierId)
    }
  }

  const createReportAndRedirect = async (_tierId: string) => {
    try {
      ...
      // Redirect to report view page which will show free tier modal
      router.push(`/reports/${data.report.id}/view`)
    } catch (error) {
  ...
  const handleAuthSuccess = () => {
    ...
    if (selectedTier) {
      // After successful auth, create report and redirect
      createReportAndRedirect(selectedTier)
    }
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="font-semibold text-slate-900">{vehicleData.trim}</div>
          ...
          <div className="mb-12">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Choose Your Report</h2>
              <p className="text-slate-600">Select the tier that best fits your needs</p>
            </div>
