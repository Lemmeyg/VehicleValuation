        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto mb-12 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <p className="text-sm text-slate-700 leading-relaxed">
              <strong>Disclaimer:</strong> The information in our knowledge base is for educational
              purposes only and does not constitute legal, financial, insurance, or professional
              advice. Vehicle valuations, pricing, VIN data, and insurance strategies are general
