 ...
 * Protected routes:
 * - /dashboard/*
 * - /reports/*  (except /reports/[id]/success — anonymous buyers land here post-payment)
 * - /profile
 */
...
export async function middleware(request: NextRequest) {
  ...
  // Routes that are exempt from the auth requirement even though they match isProtectedRoute
  const isAuthCallbackPage = request.nextUrl.pathname === '/auth/callback'
  // /reports/[id]/success is the post-payment landing page for anonymous buyers
