...
export async function generateAndUploadPDF(
  ...
  try {
    ...
    const pdfData = {
      ...
      vehicleData: reportData.vehicle_data,
      accidentDetails: reportType === 'PREMIUM' ? reportData.accident_details : undefined,
      valuationResult: reportData.valuation_result,
    }
